    ...
    <div class="swiper-container">
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                <div class="slide-inner" style="background-image:url(${pageContext.request.contextPath}/template/blog/images/slider/bg2.jpg)"></div>
            ...
            <div class="swiper-slide">
                <div class="slide-inner" style="background-image:url(${pageContext.request.contextPath}/template/blog/images/slider/bg1.jpg)"></div>
                <div class="banner_caption_text">
                    <div class="post-category">
                        <ul>
            ...
            <div class="swiper-slide">
                <div class="slide-inner" style="background-image:url(${pageContext.request.contextPath}/template/blog/images/slider/bg3.jpg)"></div>
                <div class="banner_caption_text">
                    <div class="post-category">
                        <ul>
                            <li class="cat-blue"><a href="#" class="white">Technology</a></li>
