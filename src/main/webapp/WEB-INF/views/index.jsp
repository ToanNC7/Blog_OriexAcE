                ...
                <div class="blog_post_sec">
                    <div class="blog-post_wrapper">
                        <div class="blog-post-image">
                            <img src="${pageContext.request.contextPath}/template/blog/images/blog-listing/blog_01.jpg" alt="image" class="img-responsive center-block post_img" />
                        </div>
                    ...
                    <div class="blog-post_wrapper">
                        ...
                        <div class="blog-post-image">
                            <img src="${pageContext.request.contextPath}/template/blog/images/blog-listing/blog_02.jpg" alt="image" class="img-responsive center-block post_img" />
                        </div>
                    </div>

                    <div class="blog-post_wrapper">
                        <div class="blog-post-image">
                            <img src="${pageContext.request.contextPath}/template/blog/images/blog-listing/blog_03.jpg" alt="image" class="img-responsive center-block post_img" />
                        </div>
                        <div class="post-content">
                            <div class="post-category">
                                <ul>
                    ...
                    <div class="blog-post_wrapper">
                        ...
                        <div class="blog-post-image">
                            <img src="${pageContext.request.contextPath}/template/blog/images/blog-listing/blog_05.jpg" alt="image" class="img-responsive center-block post_img" />
                        </div>
                    </div>

                    <div class="blog-post_wrapper">
                        <div class="blog-post-image">
                            <img src="${pageContext.request.contextPath}/template/blog/images/blog-listing/blog_04.jpg" alt="image" class="img-responsive center-block post_img" />
                        </div>
                        <div class="post-content">
                            <div class="post-category">
                                <ul>
                    ...
                    <div class="blog-post_wrapper">
                        ...
                        <div class="blog-post-image">
                            <img src="${pageContext.request.contextPath}/template/blog/images/blog-listing/blog_06.jpg" alt="image" class="img-responsive center-block post_img" />
                        </div>
                    </div>
                ...
                <div class="sidebar">
                    ...
                    <div class="widget widget-author text-center">
                        <div class="widget-image">
                            <img src="${pageContext.request.contextPath}/template/blog/images/blog/author.png" alt="...">
                        </div>
                        <div class="widget-author-content">
                            ...
                            <div class="widget-author-signature">
                                <img src="${pageContext.request.contextPath}/template/blog/images/blog/signature.png" alt="...">
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="widget-popular-post-main">
                                <div class="widget-posts">
                                    <div class="post-thumb">
                                        <img src="${pageContext.request.contextPath}/template/blog/images/blog/r-post-1.jpg" alt=".....">
                                    </div>
                                ...
                                <div class="widget-posts">
                                    <div class="post-thumb">
                                        <img src="${pageContext.request.contextPath}/template/blog/images/blog/r-post-2.jpg" alt=".....">
                                    </div>
                                    <div class="post-title">
                                        <div class="widget-cats">
                                            <a href="#">Technology</a>
                                ...
                                <div class="widget-posts">
                                    <div class="post-thumb">
                                        <img src="${pageContext.request.contextPath}/template/blog/images/blog/r-post-3.jpg" alt=".....">
                                    </div>
                                    <div class="post-title">
                                        <div class="widget-cats">
                                            <a href="#">Technology</a>
                    ...
                    <div class="widget widget-advertisement">
                        <div class="widget-content">
                            ...
                            <div class="widget-ads-image text-center">
                                <img src="${pageContext.request.contextPath}/template/blog/images/blog-listing/blog_07.jpg" alt="ads">
                            </div>
                        </div>
                    </div>
                </div>
