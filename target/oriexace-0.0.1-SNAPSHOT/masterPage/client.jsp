...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/template/client/css/jquery.desoslide.css">
<link
	href="${pageContext.request.contextPath}/template/client/css/style.css"
	rel='stylesheet' type='text/css' />
<link
	href="${pageContext.request.contextPath}/template/client/css/fontawesome-all.css"
	rel="stylesheet">
<link
...
<!--Header-->
	...
	<!-- js -->
	<script src="${pageContext.request.contextPath}/template/client/js/jquery-2.2.3.min.js"></script>
	<!-- //js -->
	<!-- desoslide-JavaScript -->
	<script src="${pageContext.request.contextPath}/template/client/js/jquery.desoslide.js"></script>
	<script>
	...
	<script src="${pageContext.request.contextPath}/template/client/js/jquery.flexisel.js"></script>
	<!-- //password-script -->
	<!--/ start-smoth-scrolling -->
	<script src="${pageContext.request.contextPath}/template/client/js/move-top.js"></script>
	<script src="${pageContext.request.contextPath}/template/client/js/easing.js"></script>
	<script>
	...
	<script src="${pageContext.request.contextPath}/template/client/js/bootstrap.js"></script>
<body>
